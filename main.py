...
class ModelEvaluationResult(BaseModel):
    model_output: str = Field(description="The complete output generated by the model.")
    is_factually_correct: bool = Field(
        description="Indicates whether the output  based on the provided documents."
    )
    is_output_complete: bool = Field(
        description="Indecated whether the output is complete or still missing some parts"
    )
...
def get_story(user_prompt: str, context_documents: List[Document]):
    ...
    # parser = JsonOutputParser(pydantic_object=ModelEvaluationResult)
...
prompt = "Write on how JFK's brain went missing after his death"
