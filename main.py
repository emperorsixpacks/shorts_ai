...
class StoryPrompt(BaseModel):
    model_output: str = Field(description="the answer to the question generated by the model")
...
def get_story(user_prompt: str, context_documents: List[Document]):
    ...
    penalty = AI21PenaltyData(scale=4)
    llm = AI21(model="j2-mid", ai21_api_key=AI21_API_KEY, maxTokens=500, presencePenalty=penalty)
...
prompt = "write a story on what happed to jfsks' brain after he was assasinted"
